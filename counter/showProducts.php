...
if (isset($_SESSION['username'])) {
  $counter_id=$_SESSION['username'];
   //insert user into db
   $sql="SELECT PID,PNAME,PCATEGORY,DRY_CLEAN_PRICE,STEAM_PRESS_PRICE FROM product WHERE COUNTER_ID=$counter_id;";
...
<!-- Content -->
    ...
    <br>
    <h1 style="text-align:center;font-size:30px" class="font-semibold text-xl tracking-tight">Product List</h1>
    <br><br>
    <center>
                          ...
                          <?php while($row = $result->fetch_assoc()) {?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="editProduct.php?cid=<?php echo $counter_id?>&pid=<?php echo $row['PID']?>" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                </td>
